...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-row-reverse">
      {/* Right Side: Animated Brand Area */}
      <div className="hidden lg:flex w-1/2 relative overflow-hidden flex-col justify-between p-12 bg-[#050505]">
        <div className="absolute top-[-20%] right-[-10%] w-[70%] h-[70%] bg-accent rounded-full blur-[150px] opacity-20 pointer-events-none" />
        <div className="absolute bottom-[-20%] left-[-10%] w-[70%] h-[70%] bg-primary rounded-full blur-[150px] opacity-20 pointer-events-none" />
        
        <Link to="/" className="flex justify-end items-center gap-2 group z-10 w-full">
        ...
        <div className="z-10 mt-auto text-right">
          ...
          >
            Join the <span className="text-gradient">Movement</span>. <br />
            Make an Impact.
          </motion.h1>
          <p className="text-gray-400 text-lg max-w-md ml-auto">
            Become a part of a community dedicated to sustainability and innovation. Your actions shape our tomorrow.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative z-10">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2 text-sm">Start your sustainable journey</p>
          </div>
          ...
          <form onSubmit={register} className="space-y-5">
            ...
            <button
              disabled={loading}
              className="w-full glow-btn bg-primary hover:bg-primary/90 text-white font-bold py-3.5 px-4 rounded-xl transition-all duration-200 mt-2 disabled:opacity-50"
            >
